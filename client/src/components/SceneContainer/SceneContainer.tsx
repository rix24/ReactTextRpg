...
function SceneContainer() {
    ...
    const tempPartyMembers: PartyMember[] = [
        {id: "TrystanCharacter", name: "Trystan", health: {current: 100, max: 100}, mana: {current: 50, max: 50}, armor: 10, position: 0, stats: {strength: 14, dexterity: 12, constitution: 14, wisdom: 10, intelligence: 8, charisma: 6}, level: 1, experience: 0, class: "Warrior", weapon: {name: "Longsword", minDamage: 5, maxDamage: 10, type: "Melee"}, portrait: MaleKnight},
        {id: "ElainCharacter", name: "Elain", health: {current: 120, max: 120}, mana: {current: 70, max: 70}, armor: 8, position: 0, stats: {strength: 12, dexterity: 8, constitution: 14, wisdom: 8, intelligence: 6, charisma: 14}, level: 1, experience: 0, class: "Mage", weapon: {name: "Mace", minDamage: 6, maxDamage: 8, type: "Melee"}, portrait: FemalePaladin, tempDistance: "Melee"},
        {id: "MycahCharacter", name: "Mycah", health: {current: 80, max: 80}, mana: {current: 100, max: 100}, armor: 3, position: 0, stats: {strength: 8, dexterity: 14, constitution: 10, wisdom: 10, intelligence: 16, charisma: 4}, level: 1, experience: 0, class: "Barbarian", weapon: {name: "Staff", minDamage: 3, maxDamage: 5, type: "Melee"}, portrait: MaleMageElderly, tempDistance: "Far"},
        {id: "LiranaCharacter", name: "Lirana", health: {current: 90, max: 90}, mana: {current: 60, max: 60}, armor: 4, position: 0, stats: {strength: 10, dexterity: 14, constitution: 10, wisdom: 8, intelligence: 12, charisma: 12}, level: 1, experience: 0, class: "Rogue", weapon: {name: "Shortbow", minDamage: 2, maxDamage: 6, type: "Ranged"}, portrait: FemaleRogueDemonic, tempDistance: "Close"}
    ]

    const tempEnemies: Enemy[] = [
        {id: "GnollEnemy", name: "Gnoll", health: {current: 40, max: 40}, mana: {current: 0, max: 0}, armor: 5, position: 2, challenge: 1, experienceGranted: 10, portrait: SkeletonWarrior},
        {id: "GnollEnemy", name: "Gnoll", health: {current: 40, max: 40}, mana: {current: 0, max: 0}, armor: 5, position: 2, challenge: 1, experienceGranted: 10, portrait: SkeletonWarrior},
        {id: "GnollEnemy", name: "Gnoll", health: {current: 40, max: 40}, mana: {current: 0, max: 0}, armor: 5, position: 2, challenge: 1, experienceGranted: 10, portrait: SkeletonWarrior},
        {id: "GnollMageEnemy", name: "Gnoll Mage", health: {current: 30, max: 30}, mana: {current: 50, max: 50}, armor: 3, position: 2, challenge: 2, experienceGranted: 30,  portrait: SkeletonMage} 
    ]
        ...
        <>
            <div className={Styles.sceneContainer}>
                <div className={Styles.partyUiBorderLeft}>
                    <PartyUi partyMembers={tempPartyMembers} isEnemy={false}/>
                </div>
                ...
                <div className={Styles.partyUiBorderRight}>
                    <PartyUi partyMembers={tempEnemies} isEnemy={true} /></div>  
            </div>                       
